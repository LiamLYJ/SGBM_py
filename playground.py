...
def sgm():
    ...
    parser.add_argument('--left', default='001_left.png', help='name (path) to the left image')
    parser.add_argument('--right', default='001_right.png', help='name (path) to the right image')
    ...
    np.save("left_cost_volume.npy", left_cost_volume)
